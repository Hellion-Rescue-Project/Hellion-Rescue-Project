...
The newest version of Hellion Rescue Project currently released is HRP-L 1.2. To install this version, please go to http://hellionrp.space/install and run the downloaded file. This will install our launcher, from which you can install the main mod.
